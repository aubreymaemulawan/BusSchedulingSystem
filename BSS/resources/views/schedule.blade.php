                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="bus_id" class="form-control" data-style="btn btn-link" id="bus_id"></select>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="operator_id" class="form-control" data-style="btn btn-link" id="operator_id"></select>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="dispatcher_id">Dispatcher</label>
                            <select name="dispatcher_id" class="form-control" data-style="btn btn-link" id="dispatcher_id"></select>
                        </div>
                    </div>
                </div>
                <div class="row">
                        ...
                        <tbody>
                            @foreach ($schedule as $sched)
                                ...
                                <tr> 
                                    ...
                                    @endif
                                    <td>{{$sched->operator->last_name}}, {{$sched->operator->first_name}}</td>
                                    <td>{{$sched->dispatcher->last_name}}, {{$sched->dispatcher->first_name}}</td>
                        ...
                        success: function (res) {
                            ...
                            $.each(res, function (key, value) {
                                if(value.is_active == 1){
                                    $('#operator_id').append('<option value="' + value.id + '">' + value.last_name + ", "+ value.first_name +'</option>');
                                }
                            });
                        }
                    });
                ...
                $('#company_id').on('change', function () {
                    ...
                    $.ajax({
                        ...
                        success: function (res) {
                            ...
                            $.each(res, function (key, value) {
                                if(value.is_active == 1){
                                    $('#dispatcher_id').append('<option value="' + value.id + '">' + value.last_name + ", "+ value.first_name +'</option>');
                                }
                            });
                        }
                    });
